            ...
            <div class="col-6 offset-3">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('admin.section.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="name" class=" required">Class</label>
                                            <select class="choices form-select" name="school_class_id">
