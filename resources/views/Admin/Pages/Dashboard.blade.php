                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $totalStaff }} Members</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $active_std }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $totalSubjects }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body py-4 px-">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="{{ Auth::user()->image ? asset('/Admin/user_images/' . Auth::user()->image) : asset('/Admin/user_images/1738840373.jpg') }}" alt="Face 1">
                        </div>
                        <div class="ms-2 name">
                            <h5 class="font-bold"><a href="{{ route('profile.view', encrypt( Auth::user()->id) ) }}">{{ Auth::user()->username }} </a></h5>
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="/Frontend/assets/images/faces/4.jpg">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="/Frontend/assets/images/faces/5.jpg">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="/Frontend/assets/images/faces/1.jpg">
                        </div>
                        <div class="name ms-4">
