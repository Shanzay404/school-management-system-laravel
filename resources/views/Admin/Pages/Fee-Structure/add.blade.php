                        ...
                        <div class="card-body">
                            <form class="form" action="{{ route('admin.fee.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="admission_fee"  class="form-control"
                                                placeholder="Admission Fee" name="admission_fee" value="{{ old('admission_fee') }}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="monthly_fee"  class="form-control"
                                                placeholder="Monthly Fee" name="monthly_fee" value="{{ old('monthly_fee') }}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="email" class=" required">Exam Fee</label>
                                            <input type="text" id="exam_fee"  class="form-control"
                                                placeholder="Exam Fee" name="exam_fee" value="{{ old('exam_fee') }}">
