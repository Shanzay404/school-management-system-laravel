            ...
            {{-- <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">My</li>
                    </ol>
                </nav>
            </div> --}}
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="cursor:not-allowed" id="username"  class="form-control"
                                            placeholder="Username" name="username" value="{{ $user->student->father_name }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="cursor:not-allowed" id="username"  class="form-control"
                                            placeholder="Username" name="username" value="{{ $user->student->mother_name }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="cursor:not-allowed" id="username"  class="form-control"
                                            placeholder="Username" name="username" value="{{ $user->student->dob }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="cursor:not-allowed" id="username"  class="form-control"
                                            placeholder="Username" name="username" value="{{ $user->student->admission_number }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="cursor:not-allowed" id="username"  class="form-control"
                                            placeholder="Username" name="username" value="{{ $user->student->date }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="cursor:not-allowed" id="username"  class="form-control"
                                            placeholder="Username" name="username" value="{{ $user->student->school_class->name }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="cursor:not-allowed" id="username"  class="form-control"
                                            placeholder="section" name="section" value="{{ $user->student->section->name }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
